"""
Django settings for temperature_gauge project.
...
SECRET_KEY = 'l2*xfe3k@#m@wu4*!09x3794+pei!_ykfn_6xccnnuglr8za$b'
...
ROOT_URLCONF = 'temperature_gauge.urls'
...
GRAPHENE = {
    'SCHEMA': 'temperature_gauge.schema.schema',
}
